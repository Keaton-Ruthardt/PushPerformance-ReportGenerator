...
const CMJ_METRICS = {
  jumpHeight: 'JUMP_HEIGHT_INCHES_Trial_in', // Native inches field in BigQuery
  ...
  countermovementDepth: 'COUNTERMOVEMENT_DEPTH_Trial_cm' // Convert from cm (no inches field in BigQuery)
};

// Metrics that need to be converted from cm to inches for display
const CM_TO_INCHES_METRICS = ['countermovementDepth'];
